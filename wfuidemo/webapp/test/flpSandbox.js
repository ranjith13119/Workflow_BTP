		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Workflow fiori page",
									"targetURL": "#wfUidemowfuidemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wfUidemowfuidemo-display": {
								"semanticObject": "wfUidemowfuidemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wfUidemo.wfuidemo",
									"url": sap.ui.require.toUrl("wfUidemo/wfuidemo")
								}
							}
						}
					}
