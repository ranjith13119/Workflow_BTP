		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#trailworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trailworkflowuimodule-display": {
								"semanticObject": "trailworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trail.workflowuimodule",
									"url": sap.ui.require.toUrl("trail/workflowuimodule")
								}
							}
						}
					}
